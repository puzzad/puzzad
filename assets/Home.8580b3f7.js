import{S as I,i as P,s as x,e as n,a as v,w as t,c as z,z as a,O as k,D as C,E as A,n as H,f as w,P as L,j as T,H as $}from"./index.b67658b9.js";function G(c){let l,p,e,i,m,r,y,q,u,o,j,h,_,d,g,b;return{c(){l=n("h2"),l.textContent="Puzzad: Puzzle Adventures",p=v(),e=n("main"),i=n("section"),i.innerHTML=`<h3 class="svelte-1fqfvjc">Ready to start an adventure?</h3> 
        ...
        <p>If you&#39;re a dedicated puzzler who takes parts in puzzle
            ...
            to rope some less puzzle-inclined friends into the hobby!</p>`,t(i,"id","hero"),t(i,"class","svelte-1fqfvjc"),t(y,"class","svelte-1fqfvjc"),t(o,"type","text"),t(o,"placeholder","revolving-magenta-ocelot"),t(o,"class","svelte-1fqfvjc"),t(h,"type","submit"),h.value="Play!",t(h,"class","svelte-1fqfvjc"),t(u,"class","svelte-1fqfvjc"),t(r,"id","play"),t(r,"class","svelte-1fqfvjc"),t(d,"id","intro"),t(d,"class","svelte-1fqfvjc"),t(e,"class","svelte-1fqfvjc")},m(s,f){z(s,l,f),z(s,p,f),z(s,e,f),a(e,i),a(e,m),a(e,r),a(r,y),a(r,q),a(r,u),a(u,o),k(o,c[0]),a(u,j),a(u,h),a(e,_),a(e,d),g||(b=[C(o,"input",c[2]),C(u,"submit",A(c[1]))],g=!0)},p(s,[f]){f&1&&o.value!==s[0]&&k(o,s[0])},i:H,o:H,d(s){s&&w(l),s&&w(p),s&&w(e),g=!1,L(b)}}}function S(c,l,p){let e="";const i=()=>{$("/game/"+e.toLowerCase().replaceAll(/[^a-z-]/g,""))};T.set("Puzzad");function m(){e=this.value,p(0,e)}return[e,i,m]}class Y extends I{constructor(l){super(),P(this,l,S,G,x,{})}}export{Y as default};
