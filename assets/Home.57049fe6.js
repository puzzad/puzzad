import{S as H,i as I,s as A,h as n,j as v,u as t,a as z,x as a,M as k,F as C,N as L,n as x,d as w,O as P,E as T}from"./index.fd81a935.js";function $(c){let l,p,e,i,m,r,y,q,u,o,j,h,_,d,g,b;return{c(){l=n("h2"),l.textContent="Puzzad: Puzzle Adventures",p=v(),e=n("main"),i=n("section"),i.innerHTML=`<h3 class="svelte-1fqfvjc">Ready to start an adventure?</h3> 
        ...
        <p>If you&#39;re a dedicated puzzler who takes parts in puzzle
            ...
            to rope some less puzzle-inclined friends into the hobby!</p>`,t(i,"id","hero"),t(i,"class","svelte-1fqfvjc"),t(y,"class","svelte-1fqfvjc"),t(o,"type","text"),t(o,"placeholder","revolving-magenta-ocelot"),t(o,"class","svelte-1fqfvjc"),t(h,"type","submit"),h.value="Play!",t(h,"class","svelte-1fqfvjc"),t(u,"class","svelte-1fqfvjc"),t(r,"id","play"),t(r,"class","svelte-1fqfvjc"),t(d,"id","intro"),t(d,"class","svelte-1fqfvjc"),t(e,"class","svelte-1fqfvjc")},m(s,f){z(s,l,f),z(s,p,f),z(s,e,f),a(e,i),a(e,m),a(e,r),a(r,y),a(r,q),a(r,u),a(u,o),k(o,c[0]),a(u,j),a(u,h),a(e,_),a(e,d),g||(b=[C(o,"input",c[2]),C(u,"submit",L(c[1]))],g=!0)},p(s,[f]){f&1&&o.value!==s[0]&&k(o,s[0])},i:x,o:x,d(s){s&&w(l),s&&w(p),s&&w(e),g=!1,P(b)}}}function G(c,l,p){let e="";const i=()=>{T("/game/"+e.toLowerCase().replaceAll(/[^a-z-]/g,""))};function m(){e=this.value,p(0,e)}return[e,i,m]}class S extends H{constructor(l){super(),I(this,l,G,$,A,{})}}export{S as default};
