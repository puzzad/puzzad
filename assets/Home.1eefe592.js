import{S as x,i as A,s as q,h as n,j as v,r as t,a as b,w as a,a3 as C,C as H,a4 as L,n as I,d as z,_ as P,B as T}from"./index.e664acfd.js";function $(p){let l,h,e,i,y,r,f,k,u,o,w,c,j,d,g,_;return{c(){l=n("h2"),l.textContent="Puzzad: Puzzle Adventures",h=v(),e=n("main"),i=n("section"),i.innerHTML=`<h3 class="svelte-3kmbj0">Ready to start an adventure?</h3> 
        ...
        <p>If you&#39;re a dedicated puzzler who takes parts in puzzle
            ...
            to rope some less puzzle-inclined friends into the hobby!</p>`,t(i,"id","hero"),t(i,"class","svelte-3kmbj0"),t(f,"class","svelte-3kmbj0"),t(o,"type","text"),t(o,"placeholder","revolving-magenta-ocelot"),t(o,"class","svelte-3kmbj0"),t(c,"type","submit"),c.value="Play!",t(c,"class","svelte-3kmbj0"),t(u,"class","svelte-3kmbj0"),t(r,"id","play"),t(r,"class","svelte-3kmbj0"),t(d,"id","intro"),t(d,"class","svelte-3kmbj0"),t(e,"class","svelte-3kmbj0")},m(s,m){b(s,l,m),b(s,h,m),b(s,e,m),a(e,i),a(e,y),a(e,r),a(r,f),a(r,k),a(r,u),a(u,o),C(o,p[0]),a(u,w),a(u,c),a(e,j),a(e,d),g||(_=[H(o,"input",p[2]),H(u,"submit",L(p[1]))],g=!0)},p(s,[m]){m&1&&o.value!==s[0]&&C(o,s[0])},i:I,o:I,d(s){s&&z(l),s&&z(h),s&&z(e),g=!1,P(_)}}}function G(p,l,h){let e="";const i=()=>{T("/game/"+e.toLowerCase().replaceAll(/[^a-z-]/g,""))};function y(){e=this.value,h(0,e)}return[e,i,y]}class W extends x{constructor(l){super(),A(this,l,G,$,q,{})}}export{W as default};
