import{S as H,i as I,s as A,e as n,a as v,v as t,c as z,x as a,N as k,D as C,O as P,n as x,f as w,P as L,C as T}from"./index.1ca4c1c7.js";function $(c){let l,p,e,i,m,r,y,q,u,o,j,h,_,f,g,b;return{c(){l=n("h2"),l.textContent="Puzzad: Puzzle Adventures",p=v(),e=n("main"),i=n("section"),i.innerHTML=`<h3 class="svelte-1fqfvjc">Ready to start an adventure?</h3> 
        <a href="/#/Adventures" class="svelte-1fqfvjc">Let&#39;s go \xBB</a>`,m=v(),r=n("section"),y=n("h3"),y.textContent="Got a game code?",q=v(),u=n("form"),o=n("input"),j=v(),h=n("input"),_=v(),f=n("section"),f.innerHTML=`<h3 class="svelte-1fqfvjc">What is a puzzle adventure?</h3> 
        ...
        <p>If you&#39;re a dedicated puzzler who takes parts in puzzle
            ...
            to rope some less puzzle-inclined friends into the hobby!</p>`,t(i,"id","hero"),t(i,"class","svelte-1fqfvjc"),t(y,"class","svelte-1fqfvjc"),t(o,"type","text"),t(o,"placeholder","revolving-magenta-ocelot"),t(o,"class","svelte-1fqfvjc"),t(h,"type","submit"),h.value="Play!",t(h,"class","svelte-1fqfvjc"),t(u,"class","svelte-1fqfvjc"),t(r,"id","play"),t(r,"class","svelte-1fqfvjc"),t(f,"id","intro"),t(f,"class","svelte-1fqfvjc"),t(e,"class","svelte-1fqfvjc")},m(s,d){z(s,l,d),z(s,p,d),z(s,e,d),a(e,i),a(e,m),a(e,r),a(r,y),a(r,q),a(r,u),a(u,o),k(o,c[0]),a(u,j),a(u,h),a(e,_),a(e,f),g||(b=[C(o,"input",c[2]),C(u,"submit",P(c[1]))],g=!0)},p(s,[d]){d&1&&o.value!==s[0]&&k(o,s[0])},i:x,o:x,d(s){s&&w(l),s&&w(p),s&&w(e),g=!1,L(b)}}}function G(c,l,p){let e="";const i=()=>{T("/game/"+e.toLowerCase().replaceAll(/[^a-z-]/g,""))};function m(){e=this.value,p(0,e)}return[e,i,m]}class W extends H{constructor(l){super(),I(this,l,G,$,A,{})}}export{W as default};
